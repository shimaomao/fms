package cn.com.leadu.fms.pojo.system.vo.wltemprentover;
...
/**
 * @author liujinge
 * @ClassName: WlTempRentOverVo
 * @Description: 数据迁移载体
 * @date 2018-08-04
 */
@Data
public class WlTempRentOverVo extends PageQuery<WlTempRentOver> {
	 ...
	 * @author liujinge
	 */
	private String rentOverId;

	/**
	 * @Fields  : 
	 * @author liujinge
	 */
	private List<String> rentOverIds;
