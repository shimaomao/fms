...
public interface ContChargeRpc {
    ...
    */ 
     ...
     * @Date: 2018/6/13 11:21
     */
    @RequestMapping(value = "cont_charge/fingContChargeAndReceiptByBizIdAndBizType", method = RequestMethod.GET)
    ResponseEntity<RestResponse<List<ContChargeReceiptVo>>> fingContChargeAndReceiptByBizIdAndBizType(@RequestParam("chargeBizId") String chargeBizId
            , @RequestParam("chargeBizType") String chargeBizType, @RequestParam("chargeFund") String chargeFund);
}
