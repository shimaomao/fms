...
import cn.com.leadu.fms.prebiz.validator.crmperson.validator.CrmPersCertifNoValidator;
import lombok.Data;
 ...
 * @Description: CRM个人信息保存时载体及验证
 * @date 2018-05-24
 */
@Data
public class CrmPersonSaveVo extends BaseVo<CrmPerson> {
	 ...
	 * @author ningyangyang
	 */
	@CrmPersCertifNoValidator(message = "该证件号码已经存在")
