...
public interface BizFilesRpc {
    ...
    */ 
     ...
     * @Date: 2018/5/23 10:31
     */
    @RequestMapping(value = "biz_files/findBizFilesMortgageRelFile",method = RequestMethod.GET)
    ResponseEntity<RestResponse<CommonBizFilesVo>> findBizFilesMortgageRelFile(@RequestParam("bizCode") String bizCode);
}
