 ...
 */
app.controller('mortgage_remind_Impawn_controller', ['$scope', '$http','$modal','$location', function ($scope, $http,$modal,$location) {
    ...
    $scope.impawn = function () {
        ...
        if(!$scope.form.$invalid) {
            ...
            for(var i in $scope.mortgageRemindList){
                $scope.mortgageRemindList[i].mortgageDate =  $scope.mortgageDate;
            ...
            $scope.mortgageRemindVo.mortgageStatus = "2";
