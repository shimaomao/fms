 ...
 */
app.controller('equ_mor_finance_touching_tab_controller', ['$scope', '$http', '$modal', 'toaster','$location', function ($scope, $http, $modal, toaster,$location) {
    ...
    $http.get('equ_mor_apply/findFinanceTouchingVo?equMorTaskNo=' + $scope.equMorTaskNo).success(function (data) {
        if (data.code == Response.successCode) {
            ...
            $scope.equMorChargeFinTouchingVo.bizFilesList = data.data.bizFilesList;
            var management = "";
