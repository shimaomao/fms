 ...
 */
app.controller('financial_subject_modify_controller', ['$scope', '$http','$modal','toaster','$location', function ($scope, $http, $modal, toaster,$location) {
    ...
    $scope.modify = function () {
        ...
        if(!$scope.form.$invalid) {
            ...
            $http.put('financial_subject/modifyFinancialSubject', $scope.financialSubject).success(function (data) {
                if (data.code == Response.successCode)
                    $location.path("app/finance_financial_subject_list").search({messageType:'modifyFinancialSubject'});
                else
