/**
 * Created by qiaohao on 2018/5/8.
 */
app.controller('relationEchartsController', ['$scope', '$http', '$state', '$localStorage', '$filter', '$rootScope',function($scope, $http, $state, $localStorage, $filter, $rootScope) {
