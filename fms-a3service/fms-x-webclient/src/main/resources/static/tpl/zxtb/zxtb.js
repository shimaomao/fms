app.controller('zxtbController', ['$scope', '$http', '$state', '$localStorage', '$filter', '$rootScope', '$modal', '$cookies', '$location','$stateParams',function($scope, $http, $state, $localStorage, $filter, $rootScope, $modal, $cookies, $location, $stateParams) {
