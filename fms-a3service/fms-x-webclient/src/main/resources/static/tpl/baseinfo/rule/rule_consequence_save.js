 ...
 */
app.controller('rule_consequence_save_controller', ['$scope', '$http','$modal', '$modalInstance','toaster','ruleType', function ($scope, $http,$modal, $modalInstance,toaster,ruleType) {

    $scope.ruleConsequence={conseqLogicValue2:''};
