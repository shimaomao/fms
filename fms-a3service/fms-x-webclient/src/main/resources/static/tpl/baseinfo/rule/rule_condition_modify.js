 ...
 */
app.controller('rule_condition_modify_controller', ['$scope', '$http','$modal', '$modalInstance','toaster','ruleType','ruleCondition', function ($scope, $http,$modal, $modalInstance,toaster,ruleType,ruleCondition) {
