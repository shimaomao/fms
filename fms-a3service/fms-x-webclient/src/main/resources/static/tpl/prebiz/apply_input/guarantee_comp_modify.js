 ...
 */
app.controller('guarantee_comp_modify_controller', ['$scope', '$http','$modal','toaster','$location','guaranteeCompList','$modalInstance','guaranteeComp','$compile','applyType',function ($scope, $http,$modal,toaster,$location,guaranteeCompList,$modalInstance,guaranteeComp,$compile,applyType) {
    ...
    $scope.save = function () {
        if(!$scope.form.$invalid) {
            ...
            for(var i in $scope.guaranteeCompList){
                if($scope.guaranteeCompList[i].guarCompNo==$scope.guaranteeComp.guarCompNo)
