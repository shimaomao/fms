 ...
 */
app.controller('guarantee_pers_modify_controller', ['$scope', '$http','$modal','toaster','$location','$modalInstance' ,'guaranteePersList','guaranteePers','$compile','applyType',function ($scope, $http,$modal,toaster,$location,$modalInstance,guaranteePersList,guaranteePers,$compile,applyType) {
    $scope.guaranteePers={};
    ...
    $scope.save = function () {
        if(!$scope.form.$invalid) {
            ...
            for(var i in $scope.guaranteePersList){
                if($scope.guaranteePersList[i].certifNo==$scope.guaranteePers.certifNo){
