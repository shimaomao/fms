 ...
 * 财务制单
 */
app.controller('renewal_register_voucher_controller', ['$scope', '$http','$modal','toaster','$location', function ($scope, $http,$modal,toaster,$location) {
    ...
    $scope.save = function () {
        ...
        if(!$scope.form.$invalid) {
            ...
            $http.put('renewal_register/renewalRegisterVoucher', $scope.renewalRegister).success(function (data) {
    ...
    $scope.selectBasBankInfo = function(){
        ...
        rtn.result.then(function (data) {
            if(data != null) {
                ...
                $scope.renewalRegister.payAccBranch = data.accBranchBank;
            }
        },function(){
        });
    }
     ...
     * 续保付款单打印
     */
    $scope.printRenewalRegister = function () {
        CommonFileUtils.downloadFilePost('renewal_register/printRenewalRegister',$scope.renewalRegister
            ,$http,$modal,$scope);
    }
