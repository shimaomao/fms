 ...
 */
app.controller('orig_file_archive_detail_controller', ['$scope', '$http','$modal','$compile','$location', function ($scope, $http,$modal,$compile,$location) {

    //参数配置
    $scope.dataTableProperties= {
        //ajax url 和类型
        dataTableAjax : {
            url : 'orig_file/findOrigArchiveDetailByPage',
            type:"GET"
        },
        //table的html id
        ...
        //table的列
        dataTableColumn: [
            defaultDetail('bizCode','detailArchive','合同号','30%',$compile,$scope,'bizCode'),
