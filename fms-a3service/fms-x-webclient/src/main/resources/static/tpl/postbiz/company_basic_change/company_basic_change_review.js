 ...
 */
app.controller('company_basic_change_review_controller', ['$scope', '$http','$modal','toaster','$location','$compile', function ($scope, $http,$modal,toaster,$location,$compile) {
    ...
    $scope.save = function () {
        ...
        if(!$scope.form.$invalid) {
            ...
            $http.post('company_basic_change/companyBasicChangeReview', $scope.companyBasicChangePostVo).success(function (data) {
    ...
    $scope.backUp = function () {
        ...
        if(!$scope.form.$invalid) {
            ...
            $scope.companyBasicChangePostVo.oldCompanyBasicChangeVo = $scope.oldCompanyBasicChangeVo;
            $scope.companyBasicChangePostVo.taskId = $scope.taskId;
            $http.post('company_basic_change/companyBasicChangeReviewBack', $scope.companyBasicChangePostVo).success(function (data) {
                if (data.code == Response.successCode)
                    $location.path('app/home');
                else
                    modalAlert($modal,data.message);
