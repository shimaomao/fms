 ...
 */
app.controller('collection_task_approval_controller', ['$scope', '$http','$modal','toaster', '$location',function ($scope, $http,$modal,toaster,$location) {
     ...
     * 上门催收审核通过
     */
    $scope.collectionAgree = function () {
