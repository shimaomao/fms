/**
 * Created by ningyangyang on 2018/9/4.
 * 展期合同打印
 */
app.controller('defer_task_contract_print_page_controller', ['$scope', '$http','$modal','toaster','$location',function ($scope, $http,$modal,toaster,$location) {
     ...
     * 提交展期合同信息
     */
    $scope.printDeferContract = function () {
        ...
        if(!$scope.form.$invalid) {
            ...
            $http.put('defer_task/printDeferContract', $scope.deferTask).success(function (data) {
                if (data.code == Response.successCode){
                    $location.path('/app/home').search({"type": 'homeToastInfo',"msg":'展期合同打印成功'});//我的任务页面
