app.controller('basic_change_cont_create_controller', ['$scope', '$http', '$modal', 'toaster','$compile','$location','$interval', function ($scope, $http, $modal, toaster, $compile, $location, $interval) {
    ...
    $scope.save = function () {
        if(!$scope.form.$invalid){
            ...
            $scope.changeLesseeTask.contNo = $scope.applyInput.changeLesseeTask.contNo;
            $scope.changeLesseeTask.applyInputVo = $scope.applyInput;
            $http.post('change_lessee_task/changeContGenerate',$scope.changeLesseeTask).success(function (data) {
                if(data.code == Response.successCode){
