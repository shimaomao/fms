 ...
 * 展期任务总经理审核
 */
app.controller('defer_task_manager_approve_page_controller', ['$scope', '$http','$modal','toaster','$location',function ($scope, $http,$modal,toaster,$location) {
     ...
     * 提交展期合同信息
     */
    $scope.submitManagerApprove = function () {
        ...
        if(!$scope.form.$invalid) {
            ...
            $http.put('defer_task/submitManagerApprove', $scope.deferTask).success(function (data) {
                if (data.code == Response.successCode){
                    $location.path('/app/home').search({"type": 'homeToastInfo',"msg":'总经理审核成功'});//我的任务页面
                }
                else
