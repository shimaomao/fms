 ...
 */
app.controller('car_collect_comp_modify_controller', ['$scope', '$http','$modal','toaster','$location', function ($scope, $http,$modal, toaster,$location) {
    ...
    $scope.modify = function () {
        ...
        if(!$scope.form.$invalid) {
            ...
            $http.put('car_collect_comp/modifyCarCollectComp', $scope.carCollectComp).success(function (data) {
                if (data.code == Response.successCode)
                    $location.path("app/postbiz_car_collect_comp_list").search({messageType:'modifyCarCollectComp'});
                else
