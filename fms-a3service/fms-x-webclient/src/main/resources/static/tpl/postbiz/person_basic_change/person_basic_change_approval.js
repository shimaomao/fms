 ...
 */
app.controller('person_basic_change_approval_controller', ['$scope', '$http','$modal','toaster','$location','$compile', function ($scope, $http,$modal,toaster,$location,$compile) {
    ...
    $scope.save = function () {
        if(!$scope.form.$invalid) {
            ...
            $http.post('person_basic_change/personBasicChangeApproval', $scope.personBasicChangePostVo).success(function (data) {
    ...
    $scope.backUp = function () {
        if(!$scope.form.$invalid) {
            ...
            $scope.personBasicChangePostVo.taskId = $scope.taskId;
            $scope.personBasicChangePostVo.personTaskNo = $scope.personTaskNo;
            $http.post('person_basic_change/personBasicChangeBack', $scope.personBasicChangePostVo).success(function (data) {
                if (data.code == Response.successCode)
                    $location.path('app/home');
                else
                    modalAlert($modal,data.message);
