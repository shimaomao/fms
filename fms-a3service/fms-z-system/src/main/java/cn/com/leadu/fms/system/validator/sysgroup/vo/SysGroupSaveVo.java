...
import cn.com.leadu.fms.system.validator.sysgroup.validator.SysGroupValidator;
import lombok.Data;
 ...
 * @Description: 用户组管理保存时载体及验证
 * @date 2018-03-10
 */
@Data
public class SysGroupSaveVo extends BaseVo<SysGroup> {
	...
	@SysGroupValidator(message = "用户组已经存在，不能重复添加")
