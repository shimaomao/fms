...
import cn.com.leadu.fms.system.validator.sysuser.validator.SysUserNameValidator;
import lombok.Data;
 ...
 * @author ningyangyang
 * @ClassName: SysUserVo
 * @Description: 用户管理保存时载体及验证
 * @date 2018-03-22
 */
@Data
public class SysUserSaveVo extends BaseVo<SysUser> {
	...
	@SysUserNameValidator(message = "用户代码已经存在")
	private String user;
