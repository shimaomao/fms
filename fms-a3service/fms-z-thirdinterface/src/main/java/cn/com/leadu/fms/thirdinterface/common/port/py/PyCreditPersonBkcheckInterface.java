...
import cn.com.leadu.fms.pojo.thirdinterface.PyCreditPersonBkcheckInterfaceVo;
 ...
 * @date 2018-06-6
 */
public class PyCreditPersonBkcheckInterface {
    public static PyCreditPersonBkcheckInterfaceVo getTestData(){
        String testData [][] = {
                {"测试一"	,"110000199001011112" ,     	"6225768610373340"}
        };

        PyCreditPersonBkcheckInterfaceVo testVo = new PyCreditPersonBkcheckInterfaceVo();
        ...
        testVo.setAccountNo(testData[index][2]);//手机
        return testVo;
    }
//    public static void main(String[] args) {
//        try {
//            PyCreditPersonBkcheckInterfaceVo cs= new PyCreditPersonBkcheckInterfaceVo();
//            cs.setRefID("cs001");//业务流水号(自定义CHAR(30)，可以为空)
//            cs.setName("测试一");//公司名称
//            cs.setDocumentNo("110000199001011112");//证件号码
//            cs.setAccountNo("6225768610373340");//银行账号
//            cs.setOpenBankNo("");//开户行行号(可以为空)
...
//                JSONObject personBankCheckInfo = treatResult.optJSONObject("personBankCheckInfo");
//                JSONObject item = personBankCheckInfo.optJSONObject("item");
//                if (personBankCheckInfo.has("treatResult")) {
//                    System.out.print(personBankCheckInfo.getString("treatResult"));        //得到对象中的元素
