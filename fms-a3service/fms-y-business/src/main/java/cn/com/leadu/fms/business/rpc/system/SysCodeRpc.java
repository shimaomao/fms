...
public interface SysCodeRpc {
     ...
     * @throws
     * @author qiaomengnan
     * @date 2018/06/20 02:50:08
     */
    @RequestMapping(value = "sys_code/initCommonCodeValue", method = RequestMethod.GET)
    ResponseEntity<RestResponse<Map<String,Object>>> initCommonCodeValue();
