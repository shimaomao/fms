package cn.com.leadu.fms.riskmgmt;
...
/**
 * @author qiaomengnan
 * @ClassName: FmsRiskMgmtApplication
 * @Description:
 * @date 2018/3/5
 */
...
@EnableEurekaClient
public class FmsRiskMgmtApplication {

    public static void main(String[] args) {
        SpringApplication.run(FmsRiskMgmtApplication.class,args);
    }
