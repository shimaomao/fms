...
import cn.com.leadu.fms.baseinfo.validator.baspartner.validator.BasPartnerValidator;
 ...
 * @Description: 经销商信息维护保存时载体及验证
 * @date 2018-03-17
 */
@Data
public class BasPartnerSaveVo extends BaseVo<BasPartner> {
	 ...
	 * @Fields  : 合作商代码
	 */
	@BasPartnerValidator(message = "经销商已经存在，不能重复添加！")
