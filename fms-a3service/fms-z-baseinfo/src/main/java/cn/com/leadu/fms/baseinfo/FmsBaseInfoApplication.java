package cn.com.leadu.fms.baseinfo;
...
/**
 * @author qiaomengnan
 * @ClassName: FmsBaseInfoApplication
 * @Description:
 * @date 2018/3/7
 */
...
@EnableEurekaClient
public class FmsBaseInfoApplication {

    public static void main(String[] args) {
        SpringApplication.run(FmsBaseInfoApplication.class,args);
    }
