...
import cn.com.leadu.fms.baseinfo.validator.bassales.validator.BasSalesValidator;
 ...
 * @Description: 实际销售方保存时载体及验证
 * @date 2018-05-03
 */
@Data
public class BasSalesSaveVo extends BaseVo<BasSales> {
	 ...
	 * @author yanfengbo
	 */
	@BasSalesValidator(message = "已经存在，不能重复添加")
